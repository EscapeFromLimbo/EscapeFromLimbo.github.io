...
def generateHTML():
	...
	html_content = '''<html>
	<head>
		<title>Revolution Custom Standard</title>
	...
	html_content += '''
				...
				<div class="search-help">
					<p>Search</p>
					<br>
					<p>By Set: e:ERR, e:KDT</p>
					<br>
					<p>By Format: f:eternal, f:standard</p>
					<br>
					<p>By Rules Text or Flavour Text: o:flying, ft:karina</p>
					<br>
					<p>By Mana Value, Power, or Toughness: mv=2, pow&gt4, tou&lt3</p>
					<br>
