...
def pull_all_images(play_rate_table, signature_table):
	...
	setnames = ["Stirrings in Goldport", "Valir: The Banished Isle", "Innistrad: Witching Hour", "Solastere", "Exalts of Twiltrie", "Theros: Age of Trax", "Cliques of Nylin", "Errors in the Weft", "Chikyu: Chaos Rains", "Cybaros", "Awakening in Oldun", "Kitsuo: Dusk of Time",
	...
	setcodes = ["SGP", "VLR", "IWH", "SOL", "TWI", "KDT", "ERR", "CCR", "CNY", "CYB", "OLD", "TRX", "POP", "DOV", "BLR", "KSV", "KRS", "VRD", "SVG", "GQC", "KUT", "MON", "SRC", "VST", "REV", "PLANE"]
	setcards = []
	num_sets = 26
