...
<body>
	...
	<div class="button-grid">
		<div class="select-text"><div class="results-text" id="results-text">Loading ...</div>Cards displayed as<select name="display" id="display">
			<option value="cards-only">Cards Only</option>
			<option value="cards-text">Cards + Text</option>
		</select>sorted by<select name="sort-by" id="sort-by">
	...
	html_content += '''
		...
		function search(setNewState) {
			...
			for (const card of card_list_arrayified) {
				...
				if (!card.notes.includes("standard") && !searchTerms.includes("f:") && !searchTerms.includes("e:") && !searchTerms.includes("set:") && !searchTerms.includes("cube") && !searchTerms.includes("rotated")  && !searchTerms.includes("eternal"))
				{
					continue;
				}
